    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('on tehe way', 'on the way'), ('order completed', 'order completed'), ('order canceled', 'order canceled'), ('Order Processing', 'order Processing'), ('Order Received', 'Order Received')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
